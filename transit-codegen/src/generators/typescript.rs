...
use crate::generator::{GeneratedFile, Generator, Naming};
...
TypeScript/Node.js client for the [{pascal}](https://github.com/keyva-io/{kebab}) {description}.
